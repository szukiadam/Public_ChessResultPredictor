  ...
  create or replace table `chessthesis`.`chess_thesis`.`games_with_features`
...
games_with_featured_filtered_complete as (
  select 
    * 
    except (game_id_white, game_id_black, player_id_white, player_id_black, player_side_white, player_side_black, opponent_rating_white, opponent_rating_black, result_white, result_black,game_id_opening,eco_opening)
